...
namespace AtmosphericDamage
{
    public static class Config
    {
        ...
        public const string PLANET_NAME = "Ravcor"; //this mod targets planet Kumous
        ...
        public static bool DAMAGE_PLAYERS = true; //gloabal setting to apply damage effects to players

        public static bool BLOCK_ACID_RAIN = false; //set true to apply damage only from above (like acid rain)
        public static bool PLAYER_ACID_RAIN = false; //set true to apply damage only from above (like acid rain)
        public static bool DRAW_RAIN = true;

        public static bool BLOCK_RADIATION_DAMAGE = false; //set true to apply passive radiation damage to GRIDS in atmosphere
        public static bool PLAYER_RADIATION_DAMAGE = false; //set true to apply passive radiation damage to PLAYERS in atmosphere - wont take damage when in oxygenated space.

        public static bool BLOCK_VOXEL_DAMAGE = true; //allow certain voxel types to deal damage
        public static bool PLAYER_VOXEL_DAMAGE = true; //allow certain voxel types to deal damage
